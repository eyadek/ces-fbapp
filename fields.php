...
<body background="imgs/2_en.png"  style="width:810px;background-repeat:no-repeat">
<a href="index-ar.php" style="position:absolute; left: 734px; top: 22px; width: 61px; height: 31px;"> </a>

<form name"form" action="end.php" method="post" onsubmit="return checkvalues()">
...
<select name="citys" id="citys" style="position:absolute; left: 262px; top: 552px; height: 28px; width: 267px;">
<?php include'list.php' ?>
</select>
<input type="submit"id="submitbutton" style="background:rgb(0,90,171); border-radius:5px; color:rgb(255,255,0);border:hidden; font-size:22px; position:absolute; left: 350px; top: 605px; width: 113px; height: 35px;" value="Submit" name="Submit" />
</form>
</body>
</html>